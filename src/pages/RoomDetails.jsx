  ...
  return room &&(
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Guests will be allocated on the ground floor according to availability. You get a comfortable Two bedroom aprtment has a true city feeling. The price quote is for two guest, at the guest slot please mark the number of guests to get the exact price for groups. </p>
        </div>
        {/* Hosted by */}
