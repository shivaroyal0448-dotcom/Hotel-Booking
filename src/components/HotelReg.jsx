  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
        <form className='flex bg-white rounded-xl max-w-4xl max-md:max-2'>
            ...
            <div className='relative flex flex-col items-ceter md:w-1/2 p-8 md:p-10'>
                <img src={assets.closeIcon} alt="close-icon" className='absolute top-4 right-4 h-4 w-4 cursor-pointer'/>
                <p className='text-2xl font-semibold mt-6'>Register Your Hotel</p>

                {/* Hotel Name */}
                <div className='w-full mt-4'>
                    <label htmlFor="name" className="font-mediium text-gray-500">
                        Hotel Name
                    </label>
                ...
                {/* Phone */}
                 <div className='w-full mt-4'>
                    <label htmlFor="contact" className="font-mediium text-gray-500">
                        Phone
                    </label>
                ...
                {/* Address */}
                 <div className='w-full mt-4'>
                    <label htmlFor="address" className="font-mediium text-gray-500">
                        Address
                    </label>
